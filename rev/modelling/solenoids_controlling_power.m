...
eccentricity = max (eccentricity, 0); eccentricity = min (eccentricity, .9);
...
Xs = linspace(-maxR/2, maxR/2, 2*Rsteps);
Ys = linspace(-maxR, maxR, 2*Rsteps);
...
fprintf("volume of the controllable area: %f \n", xl * yl * zl * 1e4);
